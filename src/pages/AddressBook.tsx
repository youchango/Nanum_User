...
const AddressBook = () => {
    ...
    const openForm = (addr: Address | null = null) => {
        if (addr) {
    ...
    const handleChange = (field: keyof AddressForm, value: string | boolean) => {
        setForm((prev: AddressForm) => ({ ...prev, [field]: value }));
    };

    const handleSearchAddress = () => {
        openPostcode(({ zonecode, address }: any) => {
            setForm((prev: AddressForm) => ({ ...prev, zipcode: zonecode, address }));
        });
    };
